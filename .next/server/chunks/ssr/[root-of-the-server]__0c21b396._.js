...
;
;
// Add proxy configuration for fetch
const getProxyAgent = ()=>{
    // Only import in server environment
    if ("TURBOPACK compile-time truthy", 1) {
        // Dynamic import to avoid bundling in client
        const { HttpsProxyAgent } = __turbopack_context__.r("[project]/node_modules/https-proxy-agent/dist/index.js [app-rsc] (ecmascript)");
...
async function getMatchingJobListings(prompt, jobListings, { maxNumberOfJobs } = {}) {
    ...
    Return the jobs as a comma separated list of jobIds. If you cannot find any jobs that match the user prompt, return the text "${NO_JOBS}". Here is the JSON array of available job listings: ${JSON.stringify(jobListings.map((listing)=>listingSchema.transform((listing)=>({
        ...
        model: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$inngest$2f$agent$2d$kit$2f$node_modules$2f40$inngest$2f$ai$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["gemini"])({
            model: "gemini-2.0-flash",
            apiKey: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$env$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["env"].GEMINI_API_KEY,
            fetch: (url, options)=>{
    ...
    try {
        console.log("Starting AI job matching with prompt:", prompt);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c21b396._.js.map